    ...
    <div className="space-y-4 sm:space-y-6">
      ...
      <div>
        <div className="flex items-center gap-2 mb-3 sm:mb-4">
          ...
          <h3 className="font-bold text-gray-800 text-base sm:text-lg">Người lớn</h3>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 mt-3 sm:mt-4">
          ...
          <div>
            <label className="block text-sm sm:text-base font-medium mb-1 sm:mb-2">Địa chỉ</label>
            <input
              type="text"
        ...
        <div className="mt-3 sm:mt-4">
          <label className="block text-sm sm:text-base font-medium mb-1 sm:mb-2">Ghi chú</label>
          <textarea
